    ...
    <div className="min-h-screen bg-gray-50 font-sans text-slate-800 selection:bg-amber-500 selection:text-white">
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <button
            className="md:hidden text-white flex items-center gap-3"
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        {/* Menu Panel */}
        {showContactMenu && (
          <div className="absolute bottom-20 right-0 w-72 bg-white rounded-2xl shadow-2xl border border-slate-200 p-5 space-y-5">
